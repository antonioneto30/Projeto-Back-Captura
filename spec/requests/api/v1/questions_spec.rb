...
RSpec.describe 'Questions', type: :request do
	before(:all) do
		@user = User.create!(name: 'Luis', password: 'luis42', password_confirmation: 'luis42', email: 'luis@gmail.com', cpf: '75648398763')
	...
	describe '#update' do 
		...
		context 'when the question is not updated' do 
			it 'when the user is not authenticated' do 
